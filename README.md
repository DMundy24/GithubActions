[![Run App Dillon Mundy](https://github.com/DMundy24/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/DMundy24/GithubActions/actions/workflows/run-app.yaml)
